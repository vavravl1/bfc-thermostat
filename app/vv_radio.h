...
#define VV_RADIO_DATA_TYPE_TEMPERATURE_LIVING_ROOM 1
#define VV_RADIO_DATA_TYPE_TEMPERATURE_TERRACE 2
#define VV_RADIO_DATA_TYPE_CO2 3
#define VV_RADIO_DATA_TYPE_THERMOSTAT_REFERENCE_VALUE 4
